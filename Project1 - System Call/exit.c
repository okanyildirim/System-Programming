...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	int niceValue=0;
	 if(current->static_prio>99){
		 niceValue=current->static_prio-20;			//Relationship between priority and nice value of the process		
	 }
	 else{
		niceValue=current->static_prio-120;
	 }

	 if(current->myFlag==1 && niceValue>10){  // we can also check priority if it is larger than 30 or not
				printk("myFlag is 1 and nice value is larger than 30 \n");								
		list_for_each(listofChildren, &current->children) { 	//traverse all child process and kill them
			...
			sys_kill(current->pid,SIGKILL);				// kill target process
			printk("Target process is killed...\n");									
		 //kill all child process and process 
	 }
 ////////////////////////////////////////////////////////////////////////////////////////////////////
	 else{ // exit will run normally
		printk("Normal Exit---->myFlag is 0 or priority is smaller than 30 \n");	
